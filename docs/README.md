...
| [Release notes open meldingen in de brondekking](release-notes-2026-09-17-brondekking-open-meldingen.md) | Telt open meldingen uit de bron in plaats van uit de doorgerekende set, benoemt niet-doorgerekende meldingen en vult de locatie van afgeleide DRIP-meldingen aan |
