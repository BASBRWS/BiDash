...
De gecombineerde MTM-signaalgeverbron houdt MSI en detectielussen uit elkaar. MSI-alarmen voeden signalering; detector- en lusalarmen krijgen assettype LUS en voeden detectie. Bekende LUS-codes gebruiken de bestaande impactregels. Een onbekende detectorcode blijft als open bronregel zichtbaar, maar krijgt geen impact totdat een passende regel is vastgelegd.
